...
This returns all contacts with email = 'nancy@mail.com'. Leanback will parse the native JSON results to return only the data values. If the design_document _design/email_finder and view find_by_email doesn't exist Leanback will create it in the database. See the source for the generated design_document;
 {
