...
First add a finder/index to the database
 Couchdb.add_finder(:database => 'contacts', :key => 'email') 
 # => {"ok":true,"id":"_design/email_finder","rev":"7-da7f3c0bf183f4a36a82013bd0ea6537"}
 
This will create a design document in the contacts database called _design/email_finder 
With a view called find_by_email
 {
...
Now to find documents by key (to find all contacts with email = 'nancy@mail.com')
 Couchdb.find_by( :database => 'contacts', :email => 'nancy@mail.com')  
 # => [{"_id"=>"Nancy", "_rev"=>"1-d15a83d2a23b495c19df2595b636ecc8", "firstname"=>"Nancy", "lastname"=>"Lee", "phone"=>"347-808-3734", "email"=>"nancy@mail.com", "gender"=>"female"}]

This will query the view we created above, with a
